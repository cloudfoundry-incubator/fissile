...
func scriptsTemplatesTransformationsYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/templates/transformations.yml", size: 797, mode: os.FileMode(436), modTime: time.Unix(1444059793, 0)}
...
func scriptsTemplatesTransformations_codeYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/templates/transformations_code.yml", size: 193, mode: os.FileMode(436), modTime: time.Unix(1444059793, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
