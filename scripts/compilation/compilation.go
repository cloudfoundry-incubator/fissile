...
func scriptsCompilationFakeCompileSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/compilation/fake-compile.sh", size: 6, mode: os.FileMode(436), modTime: time.Unix(1444059793, 0)}
...
func scriptsCompilationFakePrerequisitesSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/compilation/fake-prerequisites.sh", size: 6, mode: os.FileMode(436), modTime: time.Unix(1444059793, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func scriptsCompilationUbuntuCompileSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/compilation/ubuntu-compile.sh", size: 674, mode: os.FileMode(436), modTime: time.Unix(1444428203, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func scriptsCompilationUbuntuPrerequisitesSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/compilation/ubuntu-prerequisites.sh", size: 1269, mode: os.FileMode(436), modTime: time.Unix(1444095268, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
