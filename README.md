...
```
$ go get -d github.com/cloudfoundry-incubator/fissile       # Download sources
$ cd $GOPATH/src/github.com/cloudfoundry-incubator/fissile
...
[pull request]: https://github.com/cloudfoundry-incubator/fissile/pulls
