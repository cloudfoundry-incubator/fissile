...
func TestFile(t *testing.T) {
	...
	filename := path.Join(path.Join(workDir, "../test-assets"), "mustache", "test1.mustache")
...
func TestPartial(t *testing.T) {
	...
	filename := path.Join(path.Join(workDir, "../test-assets"), "mustache", "test2.mustache")
...
func TestSectionPartial(t *testing.T) {
	...
	filename := path.Join(path.Join(workDir, "../test-assets"), "mustache", "test3.mustache")
